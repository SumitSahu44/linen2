...
const Auction = () => {
  ...
  return (
    <div className="py-20 max-w-7xl mx-auto px-6">
      <div className="bg-brand-dark p-10 rounded-3xl text-white mb-12 flex flex-col md:flex-row justify-between items-center">
        <div>
        ...
        <button className="mt-6 md:mt-0 bg-white text-brand-dark px-8 py-3 rounded-xl font-black shadow-xl">Register as Vendor</button>
      </div>
      ...
      <div className="overflow-hidden border border-gray-200 rounded-2xl shadow-sm">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-gray-200">
            {tenders.map((item) => (
              <tr key={item.id} className="hover:bg-brand/5 transition text-slate-800">
                <td className="px-6 py-4 font-mono font-bold text-brand-dark">{item.id}</td>
                ...
                <td className="px-6 py-4">
                  <button className="bg-brand-dark text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-black transition">Download Tender</button>
                </td>
              </tr>
            ))}
          </tbody>
