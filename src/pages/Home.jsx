  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20">
        ...
        <div className="absolute top-20 left-10 text-[15rem] font-black text-slate-50 select-none leading-none z-0">
          KOLKATA
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-10 items-center z-10">
          ...
          <div className="lg:col-span-7">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 text-xs font-black uppercase tracking-[0.3em] rounded-full mb-6">
              Est. 1995 • Manufacturing Excellence
            </span>
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 leading-[0.9] mb-8">
              The Gold <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-900 italic">Standard</span> <br />
              In Linen.
            </h1>
            <p className="text-lg text-gray-500 max-w-xl leading-relaxed mb-10 border-l-4 border-blue-600 pl-6">
            ...
            <div className="flex flex-wrap gap-6">
              <Link to="/products" className="group relative px-10 py-5 bg-slate-900 text-white font-black uppercase tracking-widest text-xs overflow-hidden rounded-xl">
              ...
              <Link to="/trade-enquiry" className="px-10 py-5 border-2 border-slate-900 text-slate-900 font-black uppercase tracking-widest text-xs rounded-xl hover:bg-slate-900 hover:text-white transition-all">
                Get Quote
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -bottom-10 -left-10 bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 hidden md:block">
              ...
              <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Quality Export Check</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="group cursor-default">
              <h3 className="text-5xl font-black mb-2 group-hover:text-blue-400 transition-colors tracking-tighter">{stat.val}</h3>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-12 gap-6 h-full">
          {/* Card 1 */}
          <div className="md:col-span-8 group relative overflow-hidden bg-slate-50 p-12 rounded-[3rem] border border-slate-100 hover:border-blue-500 transition-all">
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <h3 className="text-3xl font-black mb-4 group-hover:text-blue-600 transition">Bulk Fabric Supply</h3>
          ...
          {/* Card 2 */}
          <div className="md:col-span-4 bg-blue-600 p-10 rounded-[3rem] text-white flex flex-col justify-between hover:bg-blue-700 transition">
             <h3 className="text-2xl font-bold italic">Contract <br/> Manufacturing</h3>
             <p className="text-blue-100 text-sm mt-4">White-label solutions for hospital, hotel, and institutional requirements.</p>
          ...
          <div className="md:col-span-12 group relative overflow-hidden bg-slate-900 p-12 rounded-[3rem] text-white border border-slate-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <Link to="/e-auction" className="px-12 py-5 bg-white text-slate-900 font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-blue-500 hover:text-white transition-all">
                Enter Portal
              </Link>
            </div>
          </div>
