  ...
  return (
    <div className="pt-32 pb-20 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative bg-brand-dark rounded-[3rem] p-12 md:p-20 overflow-hidden mb-16 shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl">
            <div className="flex items-center gap-3 text-brand font-black text-xs uppercase tracking-[0.4em] mb-6">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white leading-[0.9] uppercase italic mb-8">
              Strategic <br /> <span className="text-brand">Contracts.</span>
            </h1>
            <p className="text-white/80 text-lg font-medium leading-relaxed mb-10 border-l-2 border-brand pl-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="md:w-2/3 p-8 flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-start mb-4">
                      <span className="text-[10px] font-black text-brand bg-brand/10 px-3 py-1 rounded-full uppercase tracking-widest">{tender.id}</span>
                    ...
                    <h3 className="text-2xl font-black text-slate-900 leading-tight group-hover:text-brand transition mb-2 tracking-tighter uppercase">{tender.title}</h3>
                  ...
                  <div className="flex justify-between items-center mt-6 border-t pt-6">
                    ...
                    <div className="flex gap-2">
                      <button className="p-3 bg-slate-50 rounded-xl hover:bg-brand hover:text-white transition-all">
                        <Download size={18} />
                      </button>
                      <button className="px-6 py-3 bg-brand-dark text-white rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-black transition shadow-lg">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-xl relative overflow-hidden group">
              <div className="absolute -top-10 -right-10 w-32 h-32 bg-brand/10 rounded-full group-hover:scale-150 transition duration-700" />
              <div className="relative z-10">
                <FileText className="text-brand mb-6" size={32} />
                ...
                <button className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-brand transition shadow-lg">
                  Consult Sales
                </button>
              </div>
            </div>
            ...
            {/* Quick Fact Card */}
            <div className="bg-brand p-10 rounded-[3rem] text-white shadow-xl flex flex-col justify-between h-64">
              <h4 className="text-2xl font-black italic uppercase leading-none">Pan-India <br/> Distribution <br/> Network</h4>
              <div className="flex justify-between items-end">
                <span className="text-xs font-bold text-white/60 uppercase tracking-widest">Kolkata Hub (WB)</span>
                <Globe size={40} className="text-white/40 opacity-50" />
              </div>
            </div>
          </div>
