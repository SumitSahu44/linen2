  ...
  return (
    <div className="pt-24 pb-20 bg-slate-900 text-white min-h-screen">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <h1 className="text-6xl font-black mb-6 uppercase leading-none">Global <br/> Trade <br/> <span className="text-brand italic">Enquiry</span></h1>
          ...
          <div className="space-y-4 border-l-2 border-brand pl-6 text-sm font-bold tracking-widest uppercase">
             <div className="flex items-center gap-3"><MapPin size={20} className="text-brand" /> Kolkata Hub (West Bengal)</div>
             <div className="flex items-center gap-3"><Mail size={20} className="text-brand" /> exports@parekhlinen.com</div>
             <div className="flex items-center gap-3"><Phone size={20} className="text-brand" /> +91-XXXX-XXXXXX</div>
          </div>
        </div>

        <div className="bg-white p-10 rounded-[3rem] shadow-2xl">
          <form className="space-y-6">
            <input type="text" placeholder="Company Name" className="w-full p-4 bg-slate-50 border-none rounded-xl text-slate-900 focus:ring-2 focus:ring-brand" />
            ...
            <button className="w-full bg-brand hover:bg-brand-dark text-white font-black py-4 rounded-xl transition-all uppercase tracking-widest shadow-lg">
