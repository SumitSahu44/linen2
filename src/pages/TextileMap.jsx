...
const TextileMap = () => {
  ...
  const locations = [
    { id: 1, city: "Noida", tag: "Tech City", x: "36%", y: "24%", color: "#0ea5e9" },
    ...
    { id: 5, city: "Bangalore", tag: "Startup Valley", x: "38%", y: "82%", color: "#3b82f6" },
  ];
    ...
    <div className="py-24 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center lg:text-left mb-16">
          <span className="text-blue-600 font-bold tracking-[0.3em] uppercase text-xs">Global Network</span>
          <h2 className="text-5xl font-black text-gray-900 mt-3">Our Textile Associates</h2>
          <div className="w-24 h-2 text-blue-600 mt-4 rounded-full hidden lg:block"></div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                  ...
                  >
                    ...
                    <div className="absolute left-7 top-1/2 -translate-y-1/2 flex items-center">
                      ...
                      <div className="bg-[#0f172a] text-white px-5 py-2.5 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-700 backdrop-blur-sm min-w-[140px]">
                        ...
                        <p className="text-[9px] text-blue-600 font-bold uppercase  mt-1">{loc.tag}</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-gray-50 relative overflow-hidden">
              ...
              <h3 className="text-3xl font-black text-blue-600 mb-6 uppercase  ">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 hover:border-blue-200 transition-colors">
                    <span className="font-bold text-slate-500 uppercase tracking-widest text-xs">{stat.title}</span>
                    <span className="text-blue-600 font-black text-2xl">{stat.val}</span>
                  </div>
                ))}
              </div>

              <button className="w-full mt-10 bg-blue-400 text-white font-black py-5 rounded-2xl shadow-[0_15px_30px_rgba(30,58,138,0.3)] hover:bg-slate-900 hover:-translate-y-1 transition-all uppercase tracking-[0.2em] text-sm">
