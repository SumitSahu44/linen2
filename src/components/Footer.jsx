      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 cursor-pointer">FB</div>
            <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-400 cursor-pointer">IN</div>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm">
            ...
            <li className="hover:text-white cursor-pointer transition">Appointment (e-Form)</li>
